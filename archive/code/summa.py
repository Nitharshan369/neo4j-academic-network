...
def clear_and_populate_db():
    ...
    with driver.session() as session:
        ...
        timetable_data = [
            ...
            ("Monday", "Slot 4", "10:45 am - 11:35 am", "23MAT107", "Calculus", "F305", "CSE", "1st Semester", "Section F"),
            ("Monday", "Slot 5", "11:35 am - 12:25 pm", "23EEE104", "Introduction to Electrical & Electronics Engineering", "F305", "CSE", "1st Semester", "Section F")
        ]
...
def program1():
    ...
    # Subject Selection (empty, will populate later if needed)
